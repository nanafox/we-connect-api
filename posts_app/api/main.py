...
@app.get("/posts", response_model=dict[str, list[schemas.Post]])
...
@app.post(
    ...
    response_model=schemas.PostCreateUpdate,
)
...
@app.put("/posts/{post_id}", response_model=schemas.PostCreateUpdate)
